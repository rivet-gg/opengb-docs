...
```typescript OpenGB
await ctx.modules.email.send_email({
  // Request body
});
```
...
const response = await fetch(
  "https://localhost:8080/modules/email/scripts/send_email/call",
  {
    method: "POST",
...
var url = "https://localhost:8080/modules/email/scripts/send_email/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:8080/modules/email/scripts/send_email/call", "POST");
...
void UYourClassName::PostRequest()
{
    ...
    Request->SetURL(TEXT("https://localhost:8080/modules/email/scripts/send_email/call"));
...
let data = reqwest::Client::new()
    .post("https://localhost:8080/modules/email/scripts/send_email/call")
...
```bash curl
curl -X POST "https://localhost:8080/modules/email/scripts/send_email/call" \
