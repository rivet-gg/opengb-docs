...
```typescript OpenGB
await ctx.modules.currency.deposit({
  // Request body
});
```
...
const response = await fetch(
  "https://localhost:8080/modules/currency/scripts/deposit/call",
  {
    method: "POST",
...
var url = "https://localhost:8080/modules/currency/scripts/deposit/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:8080/modules/currency/scripts/deposit/call", "POST");
...
void UYourClassName::PostRequest()
{
    ...
    Request->SetURL(TEXT("https://localhost:8080/modules/currency/scripts/deposit/call"));
...
let data = reqwest::Client::new()
    .post("https://localhost:8080/modules/currency/scripts/deposit/call")
...
```bash curl
curl -X POST "https://localhost:8080/modules/currency/scripts/deposit/call" \
