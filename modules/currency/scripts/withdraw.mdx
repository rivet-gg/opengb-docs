...
| Source                                                                                                      | Name       | Public     |
| ----------------------------------------------------------------------------------------------------------- | ---------- | ---------- |
| [Source](https://github.com/rivet-gg/opengb-registry/tree/main/modules/currency/scripts/withdraw.ts) | `withdraw` | No |
...
const response = await fetch(
  "https://localhost:8080/modules/currency/scripts/withdraw/call",
  {
    method: "POST",
...
var url = "https://localhost:8080/modules/currency/scripts/withdraw/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:8080/modules/currency/scripts/withdraw/call", "POST");
...
void UYourClassName::PostRequest()
{
    ...
    Request->SetURL(TEXT("https://localhost:8080/modules/currency/scripts/withdraw/call"));
...
let data = reqwest::Client::new()
    .post("https://localhost:8080/modules/currency/scripts/withdraw/call")
...
```bash curl
curl -X POST "https://localhost:8080/modules/currency/scripts/withdraw/call" \
