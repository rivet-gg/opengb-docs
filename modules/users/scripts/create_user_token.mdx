...
const data = await ctx.modules.users.create_user_token({
  // Request body
});
```
...
const response = await fetch(
  "https://localhost:8080/modules/users/scripts/create_user_token/call",
  {
    method: "POST",
...
var url = "https://localhost:8080/modules/users/scripts/create_user_token/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:8080/modules/users/scripts/create_user_token/call", "POST");
...
void UYourClassName::PostRequest()
{
    ...
    Request->SetURL(TEXT("https://localhost:8080/modules/users/scripts/create_user_token/call"));
...
let data = reqwest::Client::new()
    .post("https://localhost:8080/modules/users/scripts/create_user_token/call")
...
```bash curl
curl -X POST "https://localhost:8080/modules/users/scripts/create_user_token/call" \
