...
const data = await ctx.modules.users.create_user({
  // Request body
});
```
...
const response = await fetch(
  "https://localhost:8080/modules/users/scripts/create_user/call",
  {
    method: "POST",
...
var url = "https://localhost:8080/modules/users/scripts/create_user/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:8080/modules/users/scripts/create_user/call", "POST");
...
void UYourClassName::PostRequest()
{
    ...
    Request->SetURL(TEXT("https://localhost:8080/modules/users/scripts/create_user/call"));
...
let data = reqwest::Client::new()
    .post("https://localhost:8080/modules/users/scripts/create_user/call")
...
```bash curl
curl -X POST "https://localhost:8080/modules/users/scripts/create_user/call" \
