...
```typescript OpenGB
await ctx.modules.rate_limit.throttle_public({
  // Request body
});
```
...
const response = await fetch(
  "https://localhost:8080/modules/rate_limit/scripts/throttle_public/call",
  {
    method: "POST",
...
var url = "https://localhost:8080/modules/rate_limit/scripts/throttle_public/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:8080/modules/rate_limit/scripts/throttle_public/call", "POST");
...
void UYourClassName::PostRequest()
{
    ...
    Request->SetURL(TEXT("https://localhost:8080/modules/rate_limit/scripts/throttle_public/call"));
...
let data = reqwest::Client::new()
    .post("https://localhost:8080/modules/rate_limit/scripts/throttle_public/call")
...
```bash curl
curl -X POST "https://localhost:8080/modules/rate_limit/scripts/throttle_public/call" \
