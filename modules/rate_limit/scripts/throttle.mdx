...
| Source                                                                                                      | Name       | Public     |
| ----------------------------------------------------------------------------------------------------------- | ---------- | ---------- |
| [Source](https://github.com/rivet-gg/opengb-registry/tree/main/modules/rate_limit/scripts/throttle.ts) | `throttle` | No |
...
const response = await fetch(
  "https://localhost:8080/modules/rate_limit/scripts/throttle/call",
  {
    method: "POST",
...
var url = "https://localhost:8080/modules/rate_limit/scripts/throttle/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:8080/modules/rate_limit/scripts/throttle/call", "POST");
...
void UYourClassName::PostRequest()
{
    ...
    Request->SetURL(TEXT("https://localhost:8080/modules/rate_limit/scripts/throttle/call"));
...
let data = reqwest::Client::new()
    .post("https://localhost:8080/modules/rate_limit/scripts/throttle/call")
...
```bash curl
curl -X POST "https://localhost:8080/modules/rate_limit/scripts/throttle/call" \
