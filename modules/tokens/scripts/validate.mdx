...
```typescript OpenGB
await ctx.modules.tokens.validate({
  // Request body
});
```
...
const response = await fetch(
  "https://localhost:8080/modules/tokens/scripts/validate/call",
  {
    method: "POST",
...
var url = "https://localhost:8080/modules/tokens/scripts/validate/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:8080/modules/tokens/scripts/validate/call", "POST");
...
void UYourClassName::PostRequest()
{
    ...
    Request->SetURL(TEXT("https://localhost:8080/modules/tokens/scripts/validate/call"));
...
let data = reqwest::Client::new()
    .post("https://localhost:8080/modules/tokens/scripts/validate/call")
...
```bash curl
curl -X POST "https://localhost:8080/modules/tokens/scripts/validate/call" \
