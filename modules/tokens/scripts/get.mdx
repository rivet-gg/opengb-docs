...
const response = await fetch(
  "https://localhost:8080/modules/tokens/scripts/get/call",
  {
    method: "POST",
...
var url = "https://localhost:8080/modules/tokens/scripts/get/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:8080/modules/tokens/scripts/get/call", "POST");
...
void UYourClassName::PostRequest()
{
    ...
    Request->SetURL(TEXT("https://localhost:8080/modules/tokens/scripts/get/call"));
...
let data = reqwest::Client::new()
    .post("https://localhost:8080/modules/tokens/scripts/get/call")
...
```bash curl
curl -X POST "https://localhost:8080/modules/tokens/scripts/get/call" \
