...
const response = await fetch(
  "https://localhost:8080/modules/tokens/scripts/revoke/call",
  {
    method: "POST",
...
var url = "https://localhost:8080/modules/tokens/scripts/revoke/call"
...
IEnumerator PostData() {
    ...
    var www = new UnityWebRequest("https://localhost:8080/modules/tokens/scripts/revoke/call", "POST");
...
void UYourClassName::PostRequest()
{
    ...
    Request->SetURL(TEXT("https://localhost:8080/modules/tokens/scripts/revoke/call"));
...
let data = reqwest::Client::new()
    .post("https://localhost:8080/modules/tokens/scripts/revoke/call")
...
```bash curl
curl -X POST "https://localhost:8080/modules/tokens/scripts/revoke/call" \
