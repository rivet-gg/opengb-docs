...
## How Nakama compares to Open Game Backend

### Both open-source

Both Open Game Backend and Nakama are open-source under the same license (Apache 2.0).
...
Nakama provides a managed cloud [starting at $600/mo](https://heroiclabs.com/pricing/). You should not run a server without high availability, which starts at $1,000/mo.
